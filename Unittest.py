...
def run_all_cases_test(X_train, y_train, X_test, y_test,
    ...
    """
    optimizers = ["newton_backtracking"]
    ...
    for opt in optimizers:
        ...
        for pen in penalties:
            ...
            if opt == "gd":
                ...
                w, losses = stochastic_gd(X_train, y_train, X_test, y_test, learning_rates, epochs=100, penalty=None, lam=0.01)
            elif opt == "newton":
                w, losses = newton_fixed_lr_run_all(X_train, y_train, X_test, y_test, learning_rates, epochs=50, penalty=None, lam=0.01)
            elif opt == "newton_backtracking":
                w, losses = newton_backtracking_run(X_train, y_train, X_test, y_test, epochs=50, penalty=None, lam=0.01, alpha=0.25, beta=0.8)
            elif opt == "accelerated":
                w, losses = accelerated_gd_run_all(X_train, y_train, X_test, y_test,learning_rates, epochs=200, penalty=None, lam=0.01)
    return results
